...
|---|---|---|
| [#180](https://github.com/mstorsjo/fdk-aac/issues/180) | Evaluated ([PR #17](https://github.com/penguin425/fdk-aac-rust/pull/17)) | The Android 17 tree is a 498-file encoder with a separate xHE encoder license and provenance. Track it as an isolated future port; it is not a decoder-baseline update. |
...
| [#114](https://github.com/mstorsjo/fdk-aac/issues/114) | Fixed + documented ([PR #8](https://github.com/penguin425/fdk-aac-rust/pull/8)) | Document preroll, random access, `signal_interruption()`, transport resynchronization, and trimming. A seek-equivalence regression exposed and fixes stale concealment-delay/limiter PCM crossing an interruption. |
