...
| [`docs/PERFORMANCE.md`](docs/PERFORMANCE.md) | Performance trend measurements and catastrophe guards |
| [`docs/EXTERNAL_INTEGRATION.md`](docs/EXTERNAL_INTEGRATION.md) | External streaming, seek, continuous decode, and C FFI tests |
